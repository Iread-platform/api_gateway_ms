...
docker run -p 217.182.250.236:${CONTAINER_PORT}:${INTERNAL_PORT} -p 46.227.254.20:${HTTPS_CONTAINER_PORT}:${HTTPS_INTERNAL_PORT} --name ${DOCKER_CONTAINER_NAME} --hostname ${DOCKER_CONTAINER_NAME} -d ${DOCKER_IMAGE_AND_TAG};
